...
const milestones = [
  ...
  { x: 2025, y: 87,  curve_y: null,  company: "VERITUX",                role: "Registered Independent Consultant", dates: "2025–2026", align: "middle", dx: 0, dy: -25, is_special: 0, is_current: 0 },
];
...
const engagements = [
  ...
  { title: 'Saudi CMA & Family Office Readiness',     category: 'Corporate Governance',  outcome: 'Established governance foundations for institutional capital market activity.', desc: 'Constructing board-level financial charters and reporting frameworks for Saudi Family Offices.', display_order: 3 },
