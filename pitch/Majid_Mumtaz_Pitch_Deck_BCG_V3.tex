...
\begin{frame}{Standard audit sampling leaves capital exposed; targeted diagnostics and ML-driven assurance recover hard ROI}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=3pt, top=1pt, bottom=1pt]
                \textbf{\normalsize \color{bcgGreen} Fraud \& Forensic Diagnostics}
            \end{tcolorbox}
            \textit{\small \color{gray} When the Board suspects leakage but standard testing returns clean.}
            \begin{itemize}
            ...
            \vspace{0.1cm}
            \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=3pt, top=1pt, bottom=1pt]
                \textbf{\normalsize \color{bcgGreen} Audit \& Governance Transformation}
            \end{tcolorbox}
            \textit{\small \color{gray} When internal audit acts as a compliance checkbox.}
            \begin{itemize}
        ...
        \begin{column}{0.40\textwidth}
            ...
            \begin{axis}[
                ...
                ymin=0, ymax=120,
                ylabel={\small Incidents (Indexed)},
                ...
                ytick=\empty,
                title={\textbf{\color{bcgDarkGray} Critical Fraud Incident Volume}},
...
\begin{frame}{Readiness mandates and ERM frameworks must be bulletproofed against underwriter scrutiny and cyber threats}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=3pt, top=1pt, bottom=1pt]
                \textbf{\normalsize \color{bcgGreen} Pre-IPO \& M\&A Diligence}
            \end{tcolorbox}
            \textit{\small \color{gray} When preparing for capital markets or acquiring targets.}
            \begin{itemize}
            ...
            \vspace{0.1cm}
            \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=3pt, top=1pt, bottom=1pt]
                \textbf{\normalsize \color{bcgGreen} Enterprise Risk \& IT Governance}
            \end{tcolorbox}
            \textit{\small \color{gray} When boards require quantifiable assurance over systemic exposures.}
            \begin{itemize}
        ...
        \begin{column}{0.40\textwidth}
            ...
            \begin{axis}[
                ...
                enlarge x limits=0.5,
                ymin=0, ymax=120,
                ylabel={\small Premium Costs (Indexed)},
                ...
                y axis line style={opacity=0},
                ytick=\empty,
                title={\textbf{\color{bcgDarkGray} Group Insurance Premiums}},
                title style={yshift=1.0ex}
                ]
            \addplot[fill=bcgDarkGray] coordinates {(Legacy,100)};
...
\begin{frame}{Business Problem First, Controls Second: We design frameworks that reflect commercial reality, not just compliance}
    \vspace{-0.2cm}
    \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=10pt, top=4pt, bottom=4pt]
