...
% Slide 1: True Cover Page
{
\setbeamertemplate{background}{\includegraphics[width=\paperwidth,height=\paperheight]{cover_bg.png}}
\begin{frame}[plain]
    \vspace{1.5cm}
    {\huge \textbf{\color{white} Strategic Audit \& Governance Advisory}} \\ \vspace{0.4cm}
    {\Large \color{bcgGreen} Board-Facing Assurance for Complex Operating Environments} \\ \vspace{1.5cm}
    
    {\normalsize \textbf{\color{white} Majid Mumtaz}, CIA, ACA, FCCA} \\
    {\small \color{bcgLightGray} 2026 Capabilities Briefing} \\ \vspace{0.8cm}
    
    \begin{tikzpicture}
        \draw[bcgGreen, very thick] (0,0) -- (2.5,0);
    \end{tikzpicture}
\end{frame}
}

% Slide 2: The Problem vs Solution (SCR Framework)
\begin{frame}{Traditional audit relies on 5\% sampling and compliance theatre; the Board requires 100\% commercial assurance}
    \vspace{-0.2cm}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[colback=bcgLightGray, colframe=bcgLightGray, arc=0pt, left=3pt, top=2pt, bottom=2pt]
                \textbf{\normalsize \color{bcgDarkGray} The Problem: Scaled Complexity}
            \end{tcolorbox}
            \vspace{0.1cm}
            \begin{itemize}
                \setlength{\itemsep}{4pt}
                \item \textbf{The Illusion of Coverage:} Traditional audits rely on statistical sampling, testing as little as 5\% of transactions and leaving the Board blind to 95\% of actual operational leakage.
                \item \textbf{Commercial Friction:} Legacy control frameworks are often designed by auditors who don't understand operations, creating bottlenecks that slow down the business without preventing fraud.
                \item \textbf{Scaling Exposures:} Fast-growing operators and pre-IPO companies rapidly outgrow their governance frameworks, exposing them to undetected supplier collusion and regulatory penalties.
            \end{itemize}
        \end{column}
        
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[colback=bcgGreen!15, colframe=bcgGreen!15, arc=0pt, left=3pt, top=2pt, bottom=2pt]
                \textbf{\normalsize \color{bcgGreen} The Solution: Full-Population Assurance}
            \end{tcolorbox}
            \vspace{0.1cm}
            \begin{itemize}
                \setlength{\itemsep}{4pt}
                \item \textbf{100\% Algorithmic Testing:} Deploying data extraction and ML anomaly detection pipelines to test full transaction populations, bypassing legacy sampling limits.
                \item \textbf{Business Problem First:} Designing internal controls that reflect commercial reality, ensuring governance never slows down revenue generation.
                \item \textbf{Hard ROI for the Board:} Transforming the audit function from an overhead cost center into a strategic asset that recovers cash and directly reduces insurance premiums.
            \end{itemize}
            
            \vspace{0.4cm}
            \begin{center}
                \textit{\footnotesize \color{bcgDarkGray} Try the Interactive Audit Models \& Dashboards directly on my portfolio:\\ \href{https://majidrajpar.github.io/portfolio_my/tools}{\textbf{\color{bcgGreen} majidrajpar.github.io/portfolio\_my/tools}}}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}

% Slide 3: Core Mandates 1 & 2 + Graph
...
% Slide 4: Core Mandates 3 & 4 + Graph
...
% Slide 7: Closing Page
{
\setbeamertemplate{background}{\includegraphics[width=\paperwidth,height=\paperheight]{cover_bg.png}}
\begin{frame}[plain]
    \vspace{2cm}
    {\huge \textbf{\color{white} Majid Mumtaz}} \\ \vspace{0.2cm}
    {\normalsize \color{bcgGreen} Strategic Audit \& Governance Advisory} \\ \vspace{1cm}
    
    {\small \color{white} \textbf{Email:}} {\small \color{bcgLightGray} \href{mailto:majidrajpar@gmail.com}{majidrajpar@gmail.com}} \\ \vspace{0.2cm}
    {\small \color{white} \textbf{Interactive Models:}} {\small \color{bcgLightGray} \href{https://majidrajpar.github.io/portfolio_my}{majidrajpar.github.io/portfolio\_my}} \\ \vspace{0.2cm}
    {\small \color{white} \textbf{Location:}} {\small \color{bcgLightGray} Dubai, UAE | Deployable Globally} \\ \vspace{1cm}
