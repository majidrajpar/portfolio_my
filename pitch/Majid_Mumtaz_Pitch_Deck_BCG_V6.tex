...
\begin{frame}{Traditional audit relies on 5\% sampling and compliance theatre; the Board requires 100\% commercial assurance}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \vspace{0.4cm}
            \begin{center}
                \textit{\footnotesize \color{bcgDarkGray} Try the Interactive Audit Models \& Dashboards directly on my portfolio:\\ \href{https://majidrajpar.github.io/portfolio_my}{\textbf{\color{bcgGreen} majidrajpar.github.io/portfolio\_my}}}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
