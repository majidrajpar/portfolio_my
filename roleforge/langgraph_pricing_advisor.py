...
def load_api_key() -> str:
    key_path = r"C:\Users\sorat\Desktop\Coding\Dev_api\ollama_api_key.txt"
...
| Domain Bundle | $49-$79 | Specialists |
| Complete Bundle | $199 | Power users |
| Enterprise | $499 | Teams |
...
def main():
    ...
    initial_state: AdvisorState = {
        ...
        "context": "RoleForge: 31 AI agent roles, free core engine (Apache 2.0), selling on GitHub Pages portfolio site, one-time purchases only",
        "pricing_analysis": "",
        "marketing_analysis": "",
