...
const recommendations: Record<string, Recommendation> = {
  'audit-one-min': {
    ...
    roles: ['Lead Internal Auditor', 'IT Auditor', 'Forensic Auditor', 'Compliance Auditor', 'Audit Report Writer', 'BI Analyst'],
  },
  'audit-one-future': {
    product: 'Audit Pack',
    price: 34,
  ...
  'creative-book-pack': {
    ...
    price: 19,
    reason: 'The Book Writing Pack covers project management, copy editing, and developmental editing — everything you need for book production.',
    roles: ['Book Project Manager', 'Copy Editor/Proofreader', 'Developmental Editor'],
  },
  'creative-book-complete': {
    ...
    roles: ['Book Project Manager', 'Copy Editor/Proofreader', 'Developmental Editor', 'Narrative Architect', 'Character Developer', 'World Builder', 'Dialogue Specialist'],
  },
  'creative-story-pack': {
    product: 'Creative Writing Pack',
    price: 34,
    reason: 'The Creative Writing Pack includes all 4 storytelling roles — from character development to world-building.',
    roles: ['Narrative Architect', 'Character Developer', 'World Builder', 'Dialogue Specialist'],
  },
  'creative-story-complete': {
    ...
    roles: ['Narrative Architect', 'Character Developer', 'World Builder', 'Dialogue Specialist', 'Book Project Manager', 'Copy Editor/Proofreader', 'Developmental Editor'],
  },
  'creative-philosophy-pack': {
    product: 'Philosophy Pack',
    price: 24,
    reason: 'The Philosophy Pack includes epistemology, ethics culture, logic, and history of philosophy roles.',
    roles: ['Epistemology Reviewer', 'Ethics Culture Advisor', 'History of Philosophy Scholar', 'Logic & Argumentation Analyst'],
  },
  'creative-philosophy-complete': {
    ...
    roles: ['Epistemology Reviewer', 'Ethics Culture Advisor', 'History of Philosophy Scholar', 'Logic & Argumentation Analyst', 'Narrative Architect', 'Character Developer', 'World Builder', 'Dialogue Specialist', 'Book Project Manager', 'Copy Editor/Proofreader', 'Developmental Editor'],
  },
  'data-general-pack': {
    product: 'Data Analysis Pack',
    price: 29,
    reason: 'The Data Analysis Pack includes data science, storytelling, ML engineering, visualization, and statistical review roles.',
    roles: ['Data Scientist', 'Data Storyteller', 'ML Engineer', 'Visualization Expert', 'Statistical Reviewer'],
  },
  'data-general-complete': {
    ...
    roles: ['Data Scientist', 'Data Storyteller', 'ML Engineer', 'Visualization Expert', 'Statistical Reviewer', 'Enterprise Risk Strategist', 'Credit Risk Analyst', 'Market Risk Quant', 'Operational Risk Manager', 'Scenario Modeler'],
  },
  'data-risk-pack': {
    product: 'Risk Pack',
    price: 29,
  ...
  'data-risk-complete': {
    ...
    roles: ['Enterprise Risk Strategist', 'Credit Risk Analyst', 'Market Risk Quant', 'Operational Risk Manager', 'Scenario Modeler', 'Data Scientist', 'Data Storyteller', 'ML Engineer', 'Visualization Expert', 'Statistical Reviewer'],
  },
  'governance-board-pack': {
    product: 'Governance Pack',
    price: 19,
    reason: 'The Governance Pack includes board liaison, governance analysis, ethics advisory, and data governance roles.',
    roles: ['Board Liaison', 'Governance Analyst', 'Ethics Advisor', 'Data Governance Specialist'],
  },
  'governance-board-complete': {
    ...
    roles: ['Board Liaison', 'Governance Analyst', 'Ethics Advisor', 'Data Governance Specialist', 'Lead Internal Auditor', 'IT Auditor', 'Forensic Auditor', 'Enterprise Risk Strategist', 'Credit Risk Analyst'],
  },
  'governance-data-gov-pack': {
    product: 'Governance Pack',
    price: 19,
    reason: 'The Governance Pack includes data governance, governance analysis, board liaison, and ethics advisory roles.',
    roles: ['Board Liaison', 'Governance Analyst', 'Ethics Advisor', 'Data Governance Specialist'],
  },
  'governance-data-gov-complete': {
    ...
    roles: ['Board Liaison', 'Governance Analyst', 'Ethics Advisor', 'Data Governance Specialist', 'Lead Internal Auditor', 'IT Auditor', 'Enterprise Risk Strategist', 'Credit Risk Analyst'],
  },
  ...
  'multiple-personal-complete': {
    product: 'Complete Library',
    price: 79,
    reason: 'Best value for personal multi-domain projects. All 31 roles at 72% off the individual subscription total.',
  ...
  explore: {
    ...
    roles: ['Data Scientist', 'Narrative Architect', 'Ethics Advisor'],
  },
};
