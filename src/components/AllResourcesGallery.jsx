...
const AllResourcesGallery = ({ documents, onClose }) => {
  useEffect(() => {
      ...
      <div className="container mx-auto px-8 py-20 max-w-7xl">
        ...
        >
          ...
          <p className="text-slate-400 text-xl max-w-3xl leading-relaxed">
            Audit frameworks, compliance guides, and thought leadership content — all available for free download.
          </p>
        </motion.div>
...
export default AllResourcesGallery;
