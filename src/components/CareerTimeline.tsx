...
export default function CareerTimeline({ careerData }: { careerData: any[] }) {
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={600} debounce={120}>
        <AreaChart
          ...
          onMouseMove={(e: any) => {
            if (e && e.activeTooltipIndex !== undefined) setActiveIndex(e.activeTooltipIndex);
          }}
        ...
        >
          ...
          <Area
            ...
            animationBegin={300}
          >
            <LabelList dataKey="role" content={renderCustomizedLabel} />
          </Area>
