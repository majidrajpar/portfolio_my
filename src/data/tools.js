export const tools = [
  ...
  {
    id: 'risk-simulator',
    title: 'Quantitative Risk Simulator',
    description: 'A Monte Carlo engine for simulating probable loss ranges and risk distributions. Uses Rust to run 10,000 simulations per click.',
    category: 'Enterprise Risk',
    href: '/portfolio_my/tools/risk-simulator/',
    isLive: true,
    batch: 3,
    ml: false,
    rust: true,
  },
  {
    ...
    title: 'SoD Conflict Explorer',
    description: 'High-performance access governance utility to identify Segregation of Duties conflicts across thousands of user permissions.',
    category: 'Compliance',
    href: '/portfolio_my/tools/permission-matrix/',
    isLive: true,
    batch: 3,
    ml: false,
    rust: true,
