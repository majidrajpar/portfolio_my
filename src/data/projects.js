export const strategicCaseStudies = [
  {
    id: 'ma-capital-protection',
    ...
    techStack: ['Forensic Data Analytics', 'Contract Risk Modelling', 'Board Advisory']
  },
  {
    id: 'audit-4-transformation',
    ...
    techStack: ['Python', 'Pandas', 'Machine Learning', 'SOX 404']
  },
  {
    id: 'ipo-governance-readiness',
    ...
    techStack: ['ICOFR', 'Corporate Governance', 'SCA/DFM Regulations']
  }
];

export const professionalEngagements = [
  {
    title: 'KSA Real Estate Forensic Audit',
    category: 'Fraud Forensics',
    outcome: 'Recovered SAR 3.2M annually via automated risk engine.',
    desc: 'Monitoring SAR 500M+ Capex/OpEx across residential and commercial portfolios.'
  },
  {
    title: 'Executive Financial Dashboards',
    category: 'Strategic Dashboards',
    outcome: '85% automated reporting efficiency achieved.',
    desc: 'Real-time board-level visibility into capital leaks and variance analysis.'
  },
  {
    title: 'Tadawul Nomu Listing Readiness',
    category: 'Corporate Governance',
    outcome: 'Successful governance structuring for parallel market listing.',
    desc: 'Coordinated ICOFR and regulatory submissions for KSA healthcare subsidiary.'
  },
  {
    title: 'Enterprise Risk Management (8 Countries)',
    category: 'Enterprise Risk',
    outcome: '50+ risks mapped; 28 KRIs live across 8 jurisdictions.',
    desc: 'Designed and implemented COSO ERM 2017 / ISO 31000 framework.'
  },
  {
    title: 'Whistleblowing Framework (QSR Leader)',
    category: 'Corporate Governance',
    outcome: 'Discovered SAR 12M fraud within months of launch.',
    desc: 'Designed email-based reporting and investigation protocols from scratch.'
  },
  {
    title: 'Ethics & Compliance Programme (Multi-Country)',
    category: 'Corporate Governance',
    outcome: 'Full programme live across 7 countries with EthicsPoint integration.',
    desc: 'Led sourcing, vendor evaluation, and organisation-wide rollout.'
  }
];
...
export const categoryMeta = [
  {
    ...
    description: 'Board structuring, ethics programme design, whistleblowing systems, and IPO readiness.',
  },
  {
    name: 'Fraud Forensics',
    slug: 'fraud-forensics',
    description: 'Forensic investigations, ML-powered fraud detection, and financial recovery.',
  },
  {
    name: 'Audit Transformation',
    slug: 'audit-transformation',
    description: 'Internal audit function build-out and methodology modernisation.',
  },
  {
    name: 'Enterprise Risk',
    slug: 'enterprise-risk',
    description: 'COSO ERM programme design, risk registers, and KRI dashboards.',
  },
  {
    name: 'Strategic Dashboards',
    slug: 'strategic-dashboards',
    description: 'Real-time pictures of audit status, compliance, and financial leaks.',
  },
];
